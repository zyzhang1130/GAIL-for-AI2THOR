                    ...
                    for k in range(self.g_step):
                        ...
                        if np.allclose(grad, 0):
                            ...
                            for _ in range(10):
                                ...
                                try:
                                    with open('/home/user/Documents/Zeyu/stable-baselines/Policy_training_hostory_10000(2).pickle', 'rb') as f:
                                        metaa = pickle.load(f)
                                except:
                                    pass
                                with open('/home/user/Documents/Zeyu/stable-baselines/Policy_training_hostory_10000(2).pickle', 'wb') as f:
                                    metaa.append([expectedimprove,improve])
                                    pickle.dump(metaa, f)
